...
- Branch naming: use `codex/<short-task-name>` when the user asks for a branch.
- Generated files policy: generated website assets in `assets/` are product
  content and may be committed; temporary screenshots, Playwright output,
  caches, logs, and generated agent-memory databases stay uncommitted.
